                    ...
                    @foreach ($categories as $category)
                        <div class="row py-1">
                            <div class="col-md-9 d-flex aling-items-center">
                                <a class="d-flex aling-items-center grap-2" href="{{route('categories.show',['category'=>$category->id]) }}">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Usted va a eliminar esta categoria</h1>
